...
struct ParallelMatrixOperator {
   ...
   */
  static void Execute(
      typename ENGINE::datatype op_a[NT * ENGINE::side][ENGINE::columns],
      typename ENGINE::datatype op_b[NT * ENGINE::side][ENGINE::columns]) {
#pragma HLS INLINE /* Important! Inlining the execution allows parallelism */
  ...
  static void Execute(
      typename ENGINE::datatype op_a[NT * ENGINE::side][ENGINE::columns],
      typename ENGINE::datatype op_b[NT * ENGINE::side][ENGINE::columns],
      typename ENGINE::datatype op_c[NT * ENGINE::side][ENGINE::columns]) {
#pragma HLS INLINE /* Important! Inlining the execution allows parallelism */
    /* Execute PE */
    ENGINE op{};
    op.Execute(&op_a[ENGINE::side * (N - 1)], &op_b[ENGINE::side * (N - 1)],
  ...
  static void Execute(
      ...
      typename ENGINE::datatype op_b[NT * ENGINE::side][ENGINE::columns],
      typename ENGINE::datatype op_c[NT * ENGINE::side][ENGINE::columns],
      typename ENGINE::datatype op_d[NT * ENGINE::side][ENGINE::columns]) {
#pragma HLS INLINE /* Important! Inlining the execution allows parallelism */
    /* Execute PE */
    ENGINE op{};
    op.Execute(&op_a[ENGINE::side * (N - 1)], &op_b[ENGINE::side * (N - 1)],

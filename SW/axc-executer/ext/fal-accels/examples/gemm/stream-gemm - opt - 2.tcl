...
set_directive_pipeline "$::env(TOP_FUNCTION)/accel_def"

# Matrix reception
set_directive_pipeline "data_stream_loop_packet"
set_directive_unroll "data_stream_copy_row"
set_directive_unroll "data_stream_copy_col"

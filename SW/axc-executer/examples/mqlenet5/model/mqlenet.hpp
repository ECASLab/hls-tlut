...
class MQLeNet5 : public Model {
 public:
  ...
  /**
   * @brief Destroy the MQLeNet5 object
   */
  ~MQLeNet5() = default;

  /**
   * @brief Number of layers of the MQLeNet5
   *
   */
...
inline MQLeNet5::MQLeNet5() {
  ...
  layers_ = {
      ...
      std::make_shared<
          QLayer<ap_fixed<kQT[2].first, kQT[2].second>, Pooling>>(),
      std::make_shared<QLayer<ap_fixed<kQT[3].first, kQT[3].second>, Conv2D>>(),
      std::make_shared<QLayer<ap_fixed<kQT[4].first, kQT[4].second>, Add>>(),
      std::make_shared<
          QLayer<ap_fixed<kQT[5].first, kQT[5].second>, Pooling>>(),
      std::make_shared<QLayer<ap_fixed<kQT[6].first, kQT[6].second>, Dense>>(),
      ...
      std::make_shared<
          QLayer<ap_fixed<kQT[10].first, kQT[10].second>, Dense>>(),
      std::make_shared<QLayer<ap_fixed<kQT[11].first, kQT[11].second>, Add>>(),
      std::make_shared<QLayer<ap_fixed<kQT[12].first, kQT[12].second>,
                              ReductionActivation>>()};
...
inline Runtime MQLeNet5::Load(const std::string &path,
...
inline Runtime MQLeNet5::Execute(std::shared_ptr<Executer> executer,
                                 std::shared_ptr<DataContainer> input,

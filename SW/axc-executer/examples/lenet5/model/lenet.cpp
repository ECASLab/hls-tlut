...
LeNet5::LeNet5() {
  ...
  layers_ = {std::make_shared<Layer<Conv2D>>(),
             std::make_shared<Layer<Add>>(),
             std::make_shared<Layer<Pooling>>(),
             std::make_shared<Layer<Conv2D>>(),
             std::make_shared<Layer<Add>>(),
             std::make_shared<Layer<Pooling>>(),
             std::make_shared<Layer<Dense>>(),
             std::make_shared<Layer<Add>>(),
             std::make_shared<Layer<Dense>>(),
             std::make_shared<Layer<Add>>(),
             std::make_shared<Layer<Dense>>(),
             std::make_shared<Layer<Add>>(),
             std::make_shared<Layer<ReductionActivation>>()};
...
Runtime LeNet5::Load(const std::string &path,
...
Runtime LeNet5::Execute(std::shared_ptr<Executer> executer,
